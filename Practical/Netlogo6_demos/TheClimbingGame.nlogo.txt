...
;; single-agentX variants are not used and only to make netlogo happy ~Yolan van der Horst, 2019
breed [agent1 single-agent1]
breed [agent2 single-agent2]
breed [agent3 single-agent3]
...
to setup
  ...
  ;; Agent2 is de agent boven, hij is rood gekleurd en wordt ge�nitialiseerd op (1,4)
  create-agent2 1
  [
    setxy 1 4
    facexy 1 3
